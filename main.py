...
class Main(Scene):
    def construct(self):
        ...
        t0 = MathTex(r"L^*").shift(UP)
        t1 = MathTex(r"T \prec T' \prec T''")
        t2 = MathTex(r"T \in G").shift(DOWN)
        t3 = MathTex(r"\alpha (T) \in \{1, 2, ..., r\}").shift(DOWN * 2)
        self.add(t0, t1, t2, t3)


def main():
    print("Hello from csci429-project!")
